...
namespace Project.Web.Controllers
{
	public class AccountController : Controller
	{
		...
		public async Task<IActionResult> Login(LoginViewModel loginViewModel)
		{
			...
			try
			{
				...
				if (accessRole.Contains(myStatus))
				{
					...
					{
						return RedirectToAction("RedirectUserWithRuleCheck", new { userId = serviceResponse.Data.User.Id.ToString() });
					}
		...
		public async Task<IActionResult> RedirectUserWithRuleCheck(string userId)
		{
